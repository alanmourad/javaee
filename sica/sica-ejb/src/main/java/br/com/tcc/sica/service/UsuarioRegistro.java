...
public class UsuarioRegistro {
    ...
    public void registerUser(Usuario user) {
    	log.info("Registrando usuario" + user.getName());
    	em.persist(user);
    }
	...
	public Usuario getUsuario(String name, String password) {
		...
		try {
			Usuario usuario = (Usuario) em
					.createQuery("SELECT u FROM Usuario u where u.name = :name and u.password = :password")
	...
	public void removeUser(Usuario newUser) {
		log.info("Removendo usuario" + newUser.getName());
		em.remove(newUser);
